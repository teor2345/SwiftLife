...
var updateTimer = NSTimer.scheduledTimerWithTimeInterval(1.0, target: view, selector: #selector(LifeView.periodicUpdate), userInfo: nil, repeats: true)
